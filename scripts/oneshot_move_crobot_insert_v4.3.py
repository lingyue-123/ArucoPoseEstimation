            ...
            if key in (ord('q'), 27):
                ...
                if args.no_robot:
                    ...
                    if (current_marker_type == "插枪") and (already_return_gun == False):
                        ...
                        offset_pose = [94.418, -43.041, -25.763, 10.683, -12.767, -4.471]
                ...
                current_matrix = pose_to_matrix(current_pose)
                offset_pose = [59.536, -232.541, 295.565, -14.643, 0.795, 1.2]
                ...
                current_matrix = pose_to_matrix(current_pose)
                offset_pose_cover = [19.774, -108.151, 266.077, 5.217, -12.943, -4.485]
